...
public class Minion extends card{
    ...
    String Checkability(ArrayList<ArrayList<Minion>> masa, int x1, int y1 , int x2 , int y2, int starter) {
        Minion attacker = new Minion(masa.get(x1).get(y1));
        if(attacker.frozen == 1 )
        {
            return "Attacker card is frozen.";
    ...
    void attackability(ArrayList<ArrayList<Minion>> masa, int x1, int y1 , int x2 , int y2) {
        Minion attacker = new Minion(masa.get(x1).get(y1));
